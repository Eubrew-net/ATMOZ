...
disp('--------------------------------------------------------------------------')
disp('                 Welcome to the ATMOZ uncertainty code (v10.0)            ')
...
A1_b = [0.3416 0.3395 0.341 0.342]; % Ozone absorption coefficient (atm cm)^-1
...
u_A_bp = sqrt(u_bp^2 + u_boot^2  + (Astep)^2);
u_A_sg = sqrt(u_sg^2 + u_boot^2  + (Astep)^2);
...
b = 2*10*mu_5.*A.*(10*Omega_5.*A.*sqrt(u2_mu_5).*rho(:,2,3)' + 10*mu_5.*Omega_5.*u_A_bp.*rho(:,1,2)' + (pre_5/Pstan).*B.*sqrt(u2_m_5).*rho(:,1,5)' +...  
    (m_5.*B/Pstan)*u_pre.*rho(:,2,6)' + m_5.*(pre_5/Pstan).*u_B.*rho(:,2,4)' - u_etc_f.*rho(:,2,7)');

c = u2_mu_5.*(10*Omega_5.*A).^2 + (10*mu_5.*Omega_5.*u_A_bp).^2 + ((B.*pre_5/Pstan).^2).*u2_m_5 + (m_5.*(pre_5/Pstan).*u_B).^2 +...
    ((m_5.*B./Pstan).^2).*u_pre.^2 + u_etc_f.^2 + 2*100*(Omega_5.^2).*A.*mu_5.*sqrt(u2_mu_5).*u_A_bp.*rho(:,1,3)' +...
	2*10*Omega_5.*A.*m_5.*(pre_5/Pstan).*sqrt(u2_mu_5).*u_B.*rho(:,3,4)' + 2*10*mu_5.*Omega_5.*m_5.*(pre_5/Pstan).*u_A_bp.*u_B.*rho(:,1,4)'+...
    2*10*(Omega_5.*A.*pre_5.*B/Pstan).*sqrt(u2_mu_5).*sqrt(u2_m_5).*rho(:,3,5)' + 2*10*(Omega_5.*A.*m_5.*B/Pstan).*sqrt(u2_mu_5).*u_pre.*rho(:,3,6)'+...
    2*10*(mu_5.*Omega_5.*pre_5.*B./Pstan).*u_A_bp.*sqrt(u2_m_5).*rho(:,1,5)' + 2*10*(mu_5.*Omega_5.*m_5.*B./Pstan).*u_A_bp.*u_pre.*rho(:,1,6)' +...
    ...
    2*10*mu_5.*Omega_5.*u_etc_f.*u_A_bp.*rho(:,1,7)' - 2*B.*(pre_5/Pstan).*u_etc_f.*sqrt(u2_m_5).*rho(:,5,7)'-...
...
save('ref16.mat','t_j_5','Omega_5','uo3','uo3_sg','mu_5','sza_5','ms9_5','u2_xx_5')
save('refunc16.mat','Omega_5','uo3','uo3_sg')